...
@section('title' , ' Add Category Slider ')
@section('content')
        ...
        <div class="col pt-3 ">
            <div class="card ">
                <div class="card-header">
                    <h1 class="text-primary text-center">Add New Category Slider</h1>
                </div><!-- card-header -->
                ...
                <div class="card-body">
                   ...
                   @endif
                    ...
                    <form action="{{ route('sliderposition.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div>
                            <label for="">اسم سلايدر بالعربى</label>
                            <input type="text" name="name_ar" class="form-control form-control-lg mb-3" >
                        </div>
                        <div>
                            <label for="">اسم سلايدر بالنجليزى</label>
