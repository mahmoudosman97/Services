        ...
        <div class="col pt-3 ">
            <div class="card ">
                <div class="card-header">
                    <h1 class="text-primary text-center">Add New  Slider</h1>
                </div><!-- card-header -->
                ...
                <div class="card-body">
                   ...
                   @endif
                    ...
                    <form action="{{ route('slider.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <select name="position_id" id="" class=" form form-select form-select-lg mb-3">
                                <option>Slider Position</option>
                                @foreach ($sliderpositions as $sliderposition)
                                    <option value="{{$sliderposition->id}}">
                                        {{$sliderposition->name_ar}}</option>
                                @endforeach
                            </select>
                        </div>
