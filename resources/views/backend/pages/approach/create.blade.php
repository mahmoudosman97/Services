        ...
        <div class="col pt-3 ">
            <div class="card ">
                <div class="card-header">
                    <h1 class="text-primary text-center">Add New  Approach</h1>
                </div><!-- card-header -->
                   ...
                   @endif
                    ...
                    <form action="{{ route('approach.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <textarea name="body_ar" id="cat_g_ar" cols="3" class="form-control form-control-lg mb-3"></textarea>
                        </div>
                        <div>
                            <label for="">نبذه عنه بالانجليزى</label>
                            <textarea name="body_en" id="cat_g_en" cols="3" class="form-control form-control-lg mb-3"></textarea>
                        </div>
