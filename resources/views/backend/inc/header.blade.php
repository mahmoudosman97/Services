                              ...
                              <div class="row gx-0 gy-2 row-cols-2 justify-content-center p-2">
                                 <div class="col">
                                  <a href="javascript:;">
                                    <div class="app-box text-center">  
                                      <div class="app-icon">
                                        <a href="{{ route('Blog.index') }}" class="btn btn-outline-primary radius-30">B</a>
                                      </div>
                                      <div class="app-name">
                                          <p class="mb-0 mt-1">Blogs</p>
                                      </div>
                                      </div>
                                 ...
                                 <div class="col">
                                  <a href="javascript:;">
                                    <div class="app-box text-center">
                                      <div class="app-icon">
                                        <a href="{{ route('CategoryBlog.index') }}" class="btn btn-outline-success radius-30">C.B</a>
                                      </div>
                                      <div class="app-name">
                                          <p class="mb-0 mt-1">Category Blog</p>
                                      </div>
                                      </div>
                                  </a>
                                 </div>
                                 <div class="col">
                                  <a href="javascript:;">
                                    <div class="app-box text-center">
                                      <div class="app-icon">
                                        <a href="{{ route('CategoryGallary.index') }}" class="btn btn-outline-success radius-30">C.G</a>
                                      </div>
                                      <div class="app-name">
                                          <p class="mb-0 mt-1">Category Gallary </p>
                                      </div>
                                      </div>
                                    </a>
                                 </div>
                                 <div class="col">
                                  <a href="javascript:;">
                                    <div class="app-box text-center">
                                      <div class="app-icon">
                                        <a href="{{ route('Gallary.index') }}" class="btn btn-outline-primary radius-30">G</a>
                                      </div>
                                      <div class="app-name">
                                          <p class="mb-0 mt-1">Gallary</p>
                                      </div>
                                      </div>
                                    </a>
                                 </div>
                                 ...
                                 <div class="col">
                                  <a href="javascript:;">
                                    <div class="app-box text-center">
                                      <div class="app-icon">
                                        <a href="{{ route('slider.index') }}" class="btn btn-outline-primary radius-30">S</a>
                                      </div>
                                      <div class="app-name">
                                          <p class="mb-0 mt-1">Slider</p>
                                      </div>
                                      </div>
                                    </a>
                                 </div>
                                 ...
                                 <div class="col">
                                  <a href="javascript:;">
                                    <div class="app-box text-center">
                                      <div class="app-icon">
                                        <a href="{{ route('sliderposition.index') }}" class="btn btn-outline-success radius-30">S.P</a>
                                      </div>
                                      <div class="app-name">
                                          <p class="mb-0 mt-1">Slider Position</p>
                                      </div>
                                      </div>
                                    </a>
                                 </div>
                                 ...
                                 <div class="col">
                                  <a href="javascript:;">
                                    <div class="app-box text-center">
                                      <div class="app-icon">
                                        <a href="{{ route('team.index') }}" class="btn btn-outline-success radius-30">T</a>
                                      </div>
                                      <div class="app-name">
                                          <p class="mb-0 mt-1">Team</p>
                                      </div>
                                      </div>
                                    </a>
                                 </div>
                                 <div class="col">
                                  <a href="javascript:;">
                                    <div class="app-box text-center">
                                      <div class="app-icon">
                                        <a href="{{ route('about.index') }}" class="btn btn-outline-primary radius-30">A</a>
                                      </div>
                                      <div class="app-name">
                                          <p class="mb-0 mt-1">About</p>
                                      </div>
                                      </div>
                                    </a>
                                 </div>
                                 <div class="col">
                                  <a href="javascript:;">
                                    <div class="app-box text-center">
                                      <div class="app-icon">
                                        <a href="{{ route('approach.index') }}" class="btn btn-outline-primary radius-30">A</a>
                                      </div>
                                      <div class="app-name">
                                          <p class="mb-0 mt-1">Approach</p>
                                      </div>
                                      </div>
                                    </a>
                                 </div>
                                 <div class="col">
                                  <a href="javascript:;">
                                    <div class="app-box text-center">
                                      <div class="app-icon">
                                        <a href="{{ route('client.index') }}" class="btn btn-outline-success radius-30">C</a>
                                      </div>
                                      <div class="app-name">
                                          <p class="mb-0 mt-1">Client</p>
                                      </div>
                                      </div>
                                    </a>
                                 </div>
                                 <div class="col">
                                  <a href="javascript:;">
                                    <div class="app-box text-center">
                                      <div class="app-icon">
                                        <a href="{{ route('contact.index') }}" class="btn btn-outline-success radius-30">C</a>
                                      </div>
                                      <div class="app-name">
                                          <p class="mb-0 mt-1">Contacts</p>
                                      </div>
                                      </div>
                                    </a>
                                 </div>
