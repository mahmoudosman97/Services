            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-8">
                    <div class="ttm_single_image-wrapper">
                        <img class="img-fluid auto_size" width="569" height="655" src="{{url('frontend/assets/images/single-img-03.png')}}" alt="single-03">
                    </div>
                </div> 
        ...
        <div class="container">
            <div class="row no-gutters ttm-bgcolor-skincolor">
                ...
                <div class="col-lg-6">
                    ...
                    <img class="img-fluid ttm-equal-height-image w-100" src="{{url('frontend/assets/images/bg-image/col-bgimage-3.png')}}" alt="bg-image">
                </div>
            </div><!-- row end -->
        </div>
    </section>
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="ttm-bg ttm-col-bgcolor-yes ttm-bgcolor-white ttm-right-span p-30 margin_top80 res-991-margin_top0">
                                ...
                                <div class="layer-content">
                                    ...
                                    <img class="img-fluid ttm-equal-height-image w-100" src="{{url('frontend/assets/images/bg-image/col-bgimage-4.jpg')}}" alt="bg-image">
                                </div>
                            </div>
                        </div>
                    </div><!-- row end -->
        ...
        <div class="container">
            ...
            <div class="row procedure-row position-relative mb_15">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="featured-imagebox featured-imagebox-procedure"> 
                        <div class="featured-thumbnail">
                            <img class="img-fluid auto_size" width="198" height="198" src="{{url('frontend/assets/images/process-01-198x198.jpg')}}" alt="image">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="featured-imagebox featured-imagebox-procedure"> 
                        <div class="featured-thumbnail">
                            <img class="img-fluid auto_size" width="198" height="198" src="{{url('frontend/assets/images/process-02-198x198.jpg')}}" alt="image">
                            <div class="process-num"></div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="featured-imagebox featured-imagebox-procedure"> 
                        <div class="featured-thumbnail">
                            <img class="img-fluid auto_size" width="198" height="198" src="{{url('frontend/assets/images/process-03-198x198.jpg')}}" alt="image">
                            <div class="process-num"></div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="featured-imagebox featured-imagebox-procedure"> 
                        <div class="featured-thumbnail">
                            <img class="img-fluid auto_size" width="198" height="198" src="{{url('frontend/assets/images/process-04-198x198.jpg')}}" alt="image">
                            <div class="process-num"></div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 ttm-box-col-wrapper">
                                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                                            ...
                                            <div class="ttm-box-view-overlay">
                                                <!-- featured-thumbnail -->
                                                <div class="featured-thumbnail"> 
                                                    <img class="img-fluid" src="{{url('frontend/assets/images/portfolio/portfolio-01-600x700.jpg')}}" alt="image">
                                                </div><!-- featured-thumbnail end-->
                                                <div class="ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Silk Fabric" data-rel="prettyPhoto" href="{{url('frontend/assets/images/portfolio/portfolio-01-1200x800.jpg')}}"> 
                                        ...
                                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                                            ...
                                            <div class="ttm-box-view-overlay">
                                                ...
                                                <div class="featured-thumbnail"> 
                                                    ...
                                                    <img class="img-fluid" src="{{url('frontend/assets/images/portfolio/portfolio-02-600x700.jpg')}}" alt="image">
                                                </div><!-- featured-thumbnail end-->
                                                <div class="ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Linen Fabric" data-rel="prettyPhoto" href="{{url('frontend/assets/images/portfolio/portfolio-02-1200x800.jpg')}}">
                                                        <i class="fa fa-search"></i>
                                                    </a>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 ttm-box-col-wrapper">
                                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                                            ...
                                            <div class="ttm-box-view-overlay">
                                                <!-- featured-thumbnail -->
                                                <div class="featured-thumbnail">
                                                    <img class="img-fluid" src="{{url('frontend/assets/images/portfolio/portfolio-03-600x700.jpg')}}" alt="image">
                                                </div><!-- featured-thumbnail end-->
                                                <div class="ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Wool Fabric" data-rel="prettyPhoto" href="{{url('frontend/assets/images/portfolio/portfolio-03-1200x800.jpg')}}">
                                                        <i class="fa fa-search"></i>
                                                    </a>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 ttm-box-col-wrapper">
                                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                                            ...
                                            <div class="ttm-box-view-overlay">
                                                <!-- featured-thumbnail -->
                                                <div class="featured-thumbnail"> 
                                                    <img class="img-fluid" src="{{url('frontend/assets/images/portfolio/portfolio-04-600x700.jpg')}}" alt="image">
                                                </div><!-- featured-thumbnail end-->
                                                <div class="ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Georgette Fabric" data-rel="prettyPhoto" href="{{url('frontend/assets/images/portfolio/portfolio-04-1200x800.jpg')}}">
                                                        <i class="fa fa-search"></i>
                                                    </a>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 ttm-box-col-wrapper">
                                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                                            ...
                                            <div class="ttm-box-view-overlay">
                                                <!-- featured-thumbnail -->
                                                <div class="featured-thumbnail">
                                                    <img class="img-fluid" src="{{url('frontend/assets/images/portfolio/portfolio-05-600x700.jpg')}}" alt="image">
                                                </div><!-- featured-thumbnail end-->
                                                <div class="ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Leather Material" data-rel="prettyPhoto" href="{{url('frontend/assets/images/portfolio/portfolio-05-1200x800.jpg')}}">
                                                        <i class="fa fa-search"></i>
                                                    </a>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 ttm-box-col-wrapper">
                                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                                            ...
                                            <div class="ttm-box-view-overlay">
                                                <!-- featured-thumbnail -->
                                                <div class="featured-thumbnail">
                                                    <img class="img-fluid" src="{{url('frontend/assets/images/portfolio/portfolio-06-600x700.jpg')}}" alt="image">
                                                </div><!-- featured-thumbnail end-->
                                                <div class="ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Cotton Fabric" data-rel="prettyPhoto" href="{{url('frontend/assets/images/portfolio/portfolio-06-1200x800.jpg')}}">
                                                        <i class="fa fa-search"></i>
                                                    </a>
            ...
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-8 col-md-12 mx-auto">                                   
                    <div class="ttm_single_image-wrapper imagestyle-two text-lg-right">
                        ...
                        <img class="img-fluid auto_size" src="{{url('frontend/assets/images/single-img-04.jpg')}}" alt="single_04">
                    </div>
                </div>
            </div><!-- row end -->
        </div>
            ...
            <div class="row slick_slider mb_15" data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "arrows":false, "dots":false, "autoplay":true, "infinite":true, "responsive": [{"breakpoint":1024,"settings":{"slidesToShow": 3}} , {"breakpoint":900,"settings":{"slidesToShow": 2}}, {"breakpoint":575,"settings":{"slidesToShow": 1}}]}'>
                <div class="col-lg-4">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" src="{{url('frontend/assets/images/blog/blog-01-600x430.jpg')}}" alt="blog-img">
                        </div>
                        <div class="featured-content">
                            <!-- ttm-box-post-date -->
                ...
                <div class="col-lg-4">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" src="{{url('frontend/assets/images/blog/blog-02-600x430.jpg')}}" alt="blog-img">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" src="{{url('frontend/assets/images/blog/blog-03-600x430.jpg')}}" alt="blog-img">
                        </div>
                        <div class="featured-content">
                            <!-- ttm-box-post-date -->
                            <div class="ttm-box-post-date">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" src="{{url('frontend/assets/images/blog/blog-04-600x430.jpg')}}" alt="blog-img">
                        </div>
                        <div class="featured-content">
                            <!-- ttm-box-post-date -->
                            <div class="ttm-box-post-date">
